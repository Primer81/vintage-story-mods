...
public class Core : ModSystem
{
	...
	{
		GameVersion.EnsureEqualVersionOrKillExecutable(api, FileVersionInfo.GetVersionInfo(Assembly.GetExecutingAssembly().Location).FileVersion, "1.20.7", "VSEssentials");
	}

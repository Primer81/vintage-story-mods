...
public class BlockLayeredSlowDig : Block
{
	...
	{
		int.TryParse(Variant[layerGroupCode], out var layer);
		return layer;
	}
	...
	public Block GetPrevLayer(IWorldAccessor world)
	{
		...
		if (layer > 1)
		{
			return world.BlockAccessor.GetBlock(CodeWithVariant(layerGroupCode, (layer - 1).ToString() ?? ""));
		}
		return null;
	}
	...
	public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
	{
		...
		if (world.BlockAccessor.GetBlock(blockSel.Position.AddCopy(blockSel.Face.Opposite)) is BlockLayeredSlowDig blocklsd)
		{

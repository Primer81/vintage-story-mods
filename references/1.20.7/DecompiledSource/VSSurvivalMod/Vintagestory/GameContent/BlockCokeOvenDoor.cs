...
public class BlockCokeOvenDoor : Block
{
	public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
	{
		...
		if (Variant["state"] == "closed")
		{
			...
			world.PlaySoundAt(new AssetLocation("sounds/block/cokeovendoor-open"), pos, 0.0, byPlayer);
		}
		else
		{
			...
			world.PlaySoundAt(new AssetLocation("sounds/block/cokeovendoor-close"), pos, 0.0, byPlayer);
		}
		return true;
	}
}

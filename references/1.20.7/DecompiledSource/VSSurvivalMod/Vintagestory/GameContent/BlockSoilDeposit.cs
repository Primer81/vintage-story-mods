...
public class BlockSoilDeposit : BlockSoil
{
	...
	{
		base.OnLoaded(api);
		string placeBelowBlockCode = Attributes?["placeBelowBlockCode"].AsString();
	...
	public override bool ShouldReceiveServerGameTicks(IWorldAccessor world, BlockPos pos, Random offThreadRandom, out object extra)
	{
		...
		Block grass;
		if (world.BlockAccessor.GetLightLevel(pos, EnumLightLevelType.MaxLight) < growthLightLevel || isSmotheringBlock(world, upPos))
		{

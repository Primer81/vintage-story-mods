...
public abstract class ToolBase
{
	...
	public virtual bool ShowSelection { get; }
	...
	{
		return new List<int>(new int[1] { ColorUtil.ToRgba(100, (int)(GuiStyle.DialogDefaultBgColor[2] * 255.0), (int)(GuiStyle.DialogDefaultBgColor[1] * 255.0), (int)(GuiStyle.DialogDefaultBgColor[0] * 255.0)) });
	}
	...
	{
		sapi.World.HighlightBlocks(player, 1, GetBlockHighlights(), GetBlockHighlightColors(), mode, GetBlockHighlightShape());
	}

...
public interface ISaveGame
{
    ...
    //
    // Summary:
    //     Gets a previously saved object from the savegame. Returns null if no such data
    //     under this key was previously set.
    //
    // Parameters:
    //   key:
    //     The key to look for
    ...
    //
    // Summary:
    //     Store the given data persistently to the savegame. Size limit is around 1 gigabyte
    //     for *all* data stored along with the savegame datastructure. If you need more
    //     space, you have to store it somewhere else.
    //
    // Parameters:
    //   key:
    //     Key value

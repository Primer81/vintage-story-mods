...
public interface IServerAPI
{
    ...
    //
    // Summary:
    //     All players known to the server (which joined at least once while the server
    //     was running)
    IServerPlayer[] Players { get; }

    //
    // Summary:
    //     The servers current configuration as configured in the serverconfig.json. You
    //     can set the values but you need to call MarkDirty() to have them saved
    ...
    //
    // Summary:
    //     Determines if the server process has been asked to terminate. Use this when you
    //     need to save data in a method registered using RegisterOnSave() before server
    //     quits.
    //
    // Value:
    ...
    //
    // Summary:
    //     Returns the number of seconds the current world has been running. This is the
    //     playtime displayed on the singleplayer world list.
    ...
    //
    // Summary:
    //     Allows mods to add a ServerThread. Useful for off-thread tasks which must be
    //     run continuously (at specified intervals) while the server is running. Calling
    //     code simply needs to implement IAsyncServerSystem
    //
    // Parameters:
    //   threadname:
    //
    ...
    //
    // Summary:
    //     Does a blocking wait until given thread is paused. Returns true if the thread
    //     was paused within given time
    //
    // Parameters:
    //   threadname:
    //
    ...
    //
    // Summary:
    //     Add the specified dimension to the LoadedMiniDimensions, and return its allocated
    //     subdimension index.
    //     A mini dimension is a small set of blocks up to 4096x4096x4096 used for schematic
    //     previews, vehicles etc
    int LoadMiniDimension(IMiniDimension blocks);

    //
    // Summary:
    //     Set the specified mini-dimension at the specified subdimension index, and return
    //     its index
    //     A mini dimension is a small set of blocks up to 4096x4096x4096 used for schematic
    //     previews, vehicles etc
    ...
    //
    // Summary:
    //     Get the mini-dimension at the specified subdimension index; returns null if none
    //     exists
    //     A mini dimension is a small set of blocks up to 4096x4096x4096 used for schematic
    //     previews, vehicles etc

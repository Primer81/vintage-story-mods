...
public interface IServerPlayerData
{
    ...
    //
    // Summary:
    //     The players last known player name. This may have changed since the last log
    //     in.
    string LastKnownPlayername { get; }

    //
    // Summary:
    //     Store your own custom data in here if you need. Might want to serialize your
    //     data to json code first.

...
public interface IServerChunk : IWorldChunk
{
    //
    // Summary:
    //     The game version where this chunk was created. Please note that this is not the
    //     version at which this chunk was complete. Chunks can linger around in a half
    //     complete state for a long time.
    string GameVersionCreated { get; }

    //
    // Summary:
    //     If true, this chunk is not at the edge of the loaded or generating map: all eight
    //     neighbouring chunks are fully loaded
    bool NotAtEdge { get; }

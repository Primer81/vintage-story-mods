...
public class Privilege
{
    ...
    //
    // Summary:
    //     Place or break blocks everywhere, completely ignoring area permissons. You still
    //     need to be in creative mode however.
    public static string buildblockseverywhere = "buildblockseverywhere";

    //
    // Summary:
    //     Use blocks everywhere, completely ignoring area permissons. You still need to
    //     be in creative mode however.
    ...
    //
    // Summary:
    //     Ability to set player role and ability to grant/revoke individual privileges.
    //     A player can only grant the same or a lower level group and the same or less
    //     privileges.
    ...
    //
    // Summary:
    //     Ability to issue a command for another player (e.g. teleport another player or
    //     set another players game mode)

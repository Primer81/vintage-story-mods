...
public interface IPlayerDataManager
{
    //
    // Summary:
    //     Returns a copy of the player data dictionary loaded by the server. Thats the
    //     contents of Playerdata/playerdata.json
    ...
    //
    // Summary:
    //     Resolves a player name to a player uid, independent on whether this player is
    //     online, offline or never even joined the server. This is done by contacting the
    //     auth server, so please use this method sparingly.
    //
    // Parameters:
    //   playername:
    //
    ...
    //
    // Summary:
    //     Resolves a player uid to a player name, independent on whether this player is
    //     online, offline or never even joined the server. This is done by contacting the
    //     auth server, so please use this method sparingly.
    //
    // Parameters:

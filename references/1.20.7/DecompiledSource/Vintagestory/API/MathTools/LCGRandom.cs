...
public class LCGRandom : IRandom
{
    ...
    //
    // Summary:
    //     Square root of int.MaxValue, used for generating floats with approximately 15
    //     bits / 4.5 decimal digits of precision
    ...
    //
    // Summary:
    //     Returns a random number from -1.0F - 1.0F (inclusive) with a bias towards the
    //     zero value (triangle graph, similar to how rolling two 6-sided dice and adding
    //     the result is most likely to yield 7)
    //     Precise to better than 15 binary digits / better than 4 significant figures in
    //     decimal

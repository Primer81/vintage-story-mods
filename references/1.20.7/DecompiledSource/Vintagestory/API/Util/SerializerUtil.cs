...
public static class SerializerUtil
{
    ...
    public static byte[] Serialize<T>(T data)
    {
        ...
        Serializer.Serialize((Stream)memoryStream, data);
    ...
    {
        using MemoryStream source = new MemoryStream(data);
        return Serializer.Merge((Stream)source, instance);
    }

    //
    // Summary:
    //     Uses ProtoBuf.Net to deserialize bytes into T. Returns the default value if data
    //     is null
    //
    // Parameters:
    //   data:

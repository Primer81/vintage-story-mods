...
//
// Summary:
//     A set of sounds that are defined for a block. All fields use default or empty
//     sounds if not set.
[DocumentAsJson]
public class BlockSounds
{
    ...
    //
    // Summary:
    //     Adjacent ambient sound sources are merged to avoid playing too many sounds too
    //     loudly. This is the maximum distance a sound source can be from another to allow
    //     a merge.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     Played when this block is hit. Will be overridden by Vintagestory.API.Common.BlockSounds.ByTool
    //     if an appropriate tool is set.
    [DocumentAsJson]
    public virtual AssetLocation Hit { get; set; }

    //
    // Summary:
    //     Gets the sound that occurs when a specific tool hits a block. (Note for coders:
    //     if none specified in the JSON, this will be null from version 1.20.4 onwards)
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     Gets the break sound either by the tool or by the block if the tool does not
    //     have a break sound.
    //
    // Parameters:
    //   tool:
    ...
    //
    // Summary:
    //     Gets the hit sound either by the tool or by the block if the tool does not have
    //     a hit sound.
    //
    // Parameters:
    //   tool:

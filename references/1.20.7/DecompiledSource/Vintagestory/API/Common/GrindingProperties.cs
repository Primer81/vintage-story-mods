...
public class GrindingProperties
{
    ...
    //
    // Summary:
    //     If set, the collectible is grindable in a quern and this is the resulting itemstack
    //     once the grinding time is over.
    [DocumentAsJson]
    public JsonItemStack GroundStack;

    //
    // Summary:
    //     Obsolete. Please use Vintagestory.API.Common.GrindingProperties.GroundStack instead.
    [DocumentAsJson]

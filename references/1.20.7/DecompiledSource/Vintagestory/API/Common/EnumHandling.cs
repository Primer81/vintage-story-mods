...
public enum EnumHandling
{
    ...
    //
    // Summary:
    //     Do not execute the default behavior, but let subsequent behaviors/event listeneres
    //     still execute, use return values
    PreventDefault,
    //
    // Summary:
    //     Do not execute default behavior and do not let subsequent behaviors/event listeneres
    //     execute, use return values
    PreventSubsequent
}

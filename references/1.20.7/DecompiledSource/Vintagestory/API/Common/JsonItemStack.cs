...
//
// Summary:
//     This is a representation of an item stack in JSON. It resembles a standard in-game
//     item stack but can be stored before the game is loaded.
[DocumentAsJson]
[ProtoContract]
public class JsonItemStack : IRecipeOutput
{
    ...
    //
    // Summary:
    //     Alias of Vintagestory.API.Common.JsonItemStack.StackSize. No real need to use
    //     this instead of it.
    [DocumentAsJson]
    public int Quantity
    {

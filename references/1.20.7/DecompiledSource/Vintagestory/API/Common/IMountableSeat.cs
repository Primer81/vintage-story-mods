...
public interface IMountableSeat
{
    ...
    //
    // Summary:
    //     Transformation matrix that can be used to render the mounted entity at the right
    //     position. The transform is relative to the SeatPosition. May be null.
    ...
    //
    // Summary:
    //     When the entity unloads you should write whatever you need in here to reconstruct
    //     the IMountable after it's loaded again Reconstruct it by registering a mountable
    //     instancer through api.RegisterMountable(string className, GetMountableDelegate
    //     mountableInstancer) You must also set a string with key className, that is the
    //     same string that you used for RegisterMountable()
    //
    // Parameters:
    //   tree:
    ...
    //
    // Summary:
    //     Return true if the currently mounted entity can unmount (or if not mounted in
    //     the first place)
    //
    // Parameters:
    //   entityAgent:

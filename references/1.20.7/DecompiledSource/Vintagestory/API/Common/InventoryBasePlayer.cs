...
//
// Summary:
//     Abstract class used for all inventories that are "on" the player. Any inventory
//     not inheriting from this class will not be stored to the savegame as part of

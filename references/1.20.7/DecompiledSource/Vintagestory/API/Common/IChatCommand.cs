...
public interface IChatCommand
{
    ...
    //
    // Summary:
    //     Registers an alternative name for this command, always at the root level, i.e.
    //     /name
    //
    // Parameters:
    //   name:
    ...
    //
    // Summary:
    //     Define command arguments, you'd usually want to use one of the parsers supplied
    //     from from capi.ChatCommands.Parsers
    //
    // Parameters:
    //   args:
    ...
    //
    // Summary:
    //     Optional validation step that ensures that all the command and all its subcommands
    //     has a name, handler, privilege and description defined
    void Validate();
    ...
    //
    // Summary:
    //     Add text explaining the form and interpretation of some of the more complex parameter
    //     types

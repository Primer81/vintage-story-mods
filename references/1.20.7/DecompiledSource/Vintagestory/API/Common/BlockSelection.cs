...
public class BlockSelection
{
    ...
    //
    // Summary:
    //     Always false during block use. True during placement if the Position value was
    //     offseted. Example: - When trying to place planks while aiming at rock, the Position
    //     is the one in front of the Rock and DidOffset is True - When trying to place
    //     planks while aiming at tallgrass, the Position is where the tall grass is and

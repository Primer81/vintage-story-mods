...
public class ClimateCondition
{
    ...
    //
    // Summary:
    //     If you read the now values, you can still get the world gen rain fall from this
    //     value. Between 0..1
    ...
    //
    // Summary:
    //     Nomalized value between 0..1. When loading the now values, this is set to the
    //     current precipitation value, otherwise to "yearly averages" or the values generated
    //     during worldgen

...
//
// Summary:
//     Marks an item as combustible, either by cooking, smelting or firing. This can
//     either imply it is used as a fuel, or can be cooked into another object.
[DocumentAsJson]
public class CombustibleProperties
{
    ...
    //
    // Summary:
    //     The duration, in real life seconds, that this collectible burns for when used
    //     as a fuel.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     How many degrees celsius it takes to smelt/transform this collectible into another.
    //     Required if Vintagestory.API.Common.CombustibleProperties.SmeltedStack is set.
    [DocumentAsJson]
    public int MeltingPoint;

    //
    // Summary:
    //     If there is a melting point, the max temperature it can reach. A value of 0 implies
    //     no limit.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     For how many seconds the temperature has to be above the melting point until
    //     the item is smelted. Recommended if Vintagestory.API.Common.CombustibleProperties.SmeltedStack
    //     is set.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     How many of this collectible are needed to smelt into Vintagestory.API.Common.CombustibleProperties.SmeltedStack.
    [DocumentAsJson]
    public int SmeltedRatio = 1;

    //
    // Summary:
    //     Some smelt types have specific functionality, and are also used for correct naming
    //     in the tool tip. If using Vintagestory.API.Common.EnumSmeltType.Bake, you will
    //     need to include Vintagestory.API.Common.BakingProperties in your item attributes.
    [DocumentAsJson]
    public EnumSmeltType SmeltingType;

    //
    // Summary:
    //     If set, this is the resulting itemstack once the MeltingPoint has been reached

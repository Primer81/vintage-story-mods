...
//
//   fontStack:
//     The current font, you and push a new font if this tag modifies the current font
//     or call .Peek() to get the current one
//
//   didClickLink:
//     Handler passed on by the displaying dialog that should be called if a user pressed
//     a piece of text, if it is clickable at all

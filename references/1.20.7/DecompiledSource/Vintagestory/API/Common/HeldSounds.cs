...
public class HeldSounds
{
    ...
    //
    // Summary:
    //     The path to a sound played when this item is picked up in the inventory using
    //     the mouse.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     The path to a sound played when this item is placed in the inventory using the
    //     mouse.
    [DocumentAsJson]

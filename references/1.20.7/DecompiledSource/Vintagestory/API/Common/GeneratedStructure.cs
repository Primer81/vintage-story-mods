...
public class GeneratedStructure
{
    ...
    //
    // Summary:
    //     If this flag is set, trees and shrubs will not generate inside the structure's
    //     bounding box
    public bool SuppressTreesAndShrubs;

    //
    // Summary:
    //     If this flag is set, rivulets will not generate inside the structure's bounding
    //     box

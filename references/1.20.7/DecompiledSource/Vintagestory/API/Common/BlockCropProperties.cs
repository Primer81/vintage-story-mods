...
public class BlockCropProperties
{
    ...
    //
    // Summary:
    //     Total amount of nutrient consumed to reach full maturity. (100 is the maximum
    ...
    //
    // Summary:
    //     Total time in ingame days required for the crop to reach full maturity assuming
    //     full nutrient levels
    [ProtoMember(4)]
    public float TotalGrowthDays;

    //
    // Summary:
    //     Total time in ingame months required for the crop to reach full maturity assuming
    //     full nutrient levels
    [ProtoMember(11)]
    ...
    //
    // Summary:
    //     When multiple harvets is true, this is the amount of growth stages the crop should
    //     go back when harvested
    [ProtoMember(6)]
    ...
    //
    // Summary:
    //     Allows customization of crop growth behavior. BlockEntityFarmland calls methods
    //     on all behaviors to allow greater control.

...
public interface IMiniDimension : IBlockAccessor
{
    ...
    //
    // Summary:
    //     If this matches the subDimensionId, it indicates that this is a blocks preview
    //     minidimension
    ...
    //
    // Summary:
    //     Clears this mini-dimension (and empties any chunks but does not unload them)
    //     ready for re-use
    void ClearChunks();

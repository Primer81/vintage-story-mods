...
public interface IMapChunk
{
    ...
    //
    // Summary:
    //     The position of the last block before the first airblock before world gen pass
    //     Vegetation
    ...
    //
    // Summary:
    //     Server: Can be used to store custom data along with the map chunk Client: Not
    //     implemented. Map chunk Moddata is not synced from server to client
    //
    // Parameters:
    //   key:
    //
    ...
    //
    // Summary:
    //     Server: Can be used to retrieve custom data from the map chunk (as previously
    //     set by SetModdata) Client: Not implemented. Map chunk Moddata is not synced from
    //     server to client
    //
    // Parameters:
    //   key:
    ...
    //
    // Summary:
    //     Causes the TTL counter to reset so that it the mapchunk does not unload. No effect
    //     when called client side.
    void MarkFresh();

    //
    // Summary:
    //     Tells the server that it has to save the changes of this chunk to disk. No effect
    //     when called client side.
    void MarkDirty();
}

...
public class AnimationTrigger
{
    ...
    //
    // Summary:
    //     If set to true, all OnControls elements need to be happening simultaneously to
    //     trigger the animation. If set to false, at least one OnControls element needs
    //     to be happening to trigger the animation. Defaults to false.
    [JsonProperty]

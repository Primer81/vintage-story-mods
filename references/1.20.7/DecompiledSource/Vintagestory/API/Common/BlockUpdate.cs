...
public class BlockUpdate
{
    ...
    //
    // Summary:
    //     If this value is negative, it indicates no change to the block (neither air block
    //     nor anything else) because only the fluid is being updated
    public int NewSolidBlockId = -1;

    //
    // Summary:
    //     If this value is negative, it indicates no change to the fluids layer block (neither
    //     air block nor anything else) because only the solid block is being updated

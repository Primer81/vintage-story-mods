...
public interface INetworkAPI
{
    //
    // Summary:
    //     Supplies you with your very own and personal network channel with which you can
    //     send packets to the server. Use the same channelName on the client and server
    //     to have them link up.
    //
    // Parameters:
    //   channelName:
    ...
    //     Supplies you with your very own and personal network channel with which you can
    //     send packets to the server. Use the same channelName on the client and server
    //     to have them link up. Do not send larger messages then 508 bytes since some clients
    //     may be behind NAT/firwalls that may drop your packets if they get fragmented
    //
    //
    // Parameters:
    //   channelName:

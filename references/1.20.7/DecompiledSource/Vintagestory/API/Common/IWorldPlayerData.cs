...
//
// Summary:
//     Some world-specific information about a connected player. If you want modify
//     any value, also broadcast the playerdata to all connected clients. This is the
//     object that stored and loaded with the save game
public interface IWorldPlayerData
{
    ...
    //
    // Summary:
    //     The players current game mode. Will return Spectator mode while the player is
    //     connecting.
    ...
    //
    // Summary:
    //     Whether the player is forcefully kept on vertical or horizontal plane during
    //     freemove

...
public interface ILandClaimAPI
{
    ...
    //
    // Summary:
    //     Checks with the permission system if given player has use or place/break permissions
    //     on supplied position. Returns always true when called on the client!
    //
    // Parameters:
    //   player:
    //
    ...
    //
    // Summary:
    //     Same as Vintagestory.API.Common.ILandClaimAPI.TestAccess(Vintagestory.API.Common.IPlayer,Vintagestory.API.MathTools.BlockPos,Vintagestory.API.Common.EnumBlockAccessFlags)
    //     but also sends an error message to the player and executes a MarkDirty() event
    //     the block. Returns always true when called on the client!
    //
    // Parameters:
    //   player:
    //

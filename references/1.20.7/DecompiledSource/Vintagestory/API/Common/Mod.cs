...
//
// Summary:
//     Represents a mod in the mod manager. May contain zero to multiple Vintagestory.API.Common.ModSystem
//     instances within it.
public abstract class Mod
{
    ...
    //
    // Summary:
    //     Gets the info of this mod. Found either as "modinfo.json" in the of the mod's
    //     folder or archive, or in the case of raw .cs and .dll files, using the Vintagestory.API.Common.ModInfoAttribute
    //     on the assembly.
    ...
    //
    // Summary:
    //     Holds the icon of this mod. Found as "modicon.png" in the root of the mod's folder
    //     or archive. May be null.

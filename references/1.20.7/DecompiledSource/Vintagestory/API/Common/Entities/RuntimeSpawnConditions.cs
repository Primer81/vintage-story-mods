...
//
// Summary:
//     A set of spawn conditions for chunks that have already been generated. Most properties
//     are got from Vintagestory.API.Common.Entities.BaseSpawnConditions.
[DocumentAsJson]
public class RuntimeSpawnConditions : BaseSpawnConditions
{
    //
    // Summary:
    //     The chance, usually between 0 (0% chance) and 1 (100% chance), for the entity
    //     to spawn during the spawning round.
    [DocumentAsJson]
    ...
    //     With more than one player, the max number is actually (this)x(current player
    //     count)x(Vintagestory.API.Common.Entities.RuntimeSpawnConditions.SpawnCapPlayerScaling).
    //     Consider using Vintagestory.API.Common.Entities.RuntimeSpawnConditions.MaxQuantityByGroup
    //     to allow a max quantity based from many entities.
    [DocumentAsJson]
    ...
    //     For example, using Vintagestory.API.Common.Entities.RuntimeSpawnConditions.MaxQuantity
    //     will allow a max of 20 pig-wild-male instances. Using this with a group of "pig-*"
    //     will allow a max of 20 pig entities, regardless if male, female, or piglet.
    [DocumentAsJson]
    public QuantityByGroup MaxQuantityByGroup;

    //
    // Summary:
    //     The maximum number of this entity that can exist in the world is Vintagestory.API.Common.Entities.RuntimeSpawnConditions.MaxQuantity
    //     x (current player count) x (this).
    [DocumentAsJson]

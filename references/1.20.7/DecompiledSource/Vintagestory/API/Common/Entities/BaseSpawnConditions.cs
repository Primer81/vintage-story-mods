...
public class BaseSpawnConditions : ClimateSpawnCondition
{
    ...
    //     - neutral
    //     - passive
    //     Hostile creatures should be defined as such here. This will automatically stop
    //     them spawning with a grace timer, and in locations where hostiles should not
    //     spawn.
    [DocumentAsJson]
    public string Group;
    ...
    //
    // Summary:
    //     Whether the rain and temperature values are referring to the worldgen values
    //     (i.e. yearly averages) or the current values at the moment of spawning.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     Obsolete. Use Vintagestory.API.Common.Entities.BaseSpawnConditions.HerdSize instead.
    [DocumentAsJson]

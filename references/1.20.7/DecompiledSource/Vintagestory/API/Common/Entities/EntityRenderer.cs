...
public abstract class EntityRenderer
{
    ...
    //
    // Summary:
    //     Draw call with the Entityanimated shader loaded and initialized with the correct
    //     color/fog/sunlight/texture values If shadows are enabled, then this method is
    //     called again with shadowmap shader intialized
    //
    // Parameters:
    //   dt:
    //
    ...
    //
    // Summary:
    //     Ortho mode draw call for 2d gui stuff, like name tags. Gui shader initialized
    //     already.
    //
    // Parameters:
    //   dt:
    ...
    //
    // Summary:
    //     Called before gui rendering starts. Drawing of the whole model into a gui dialog.
    //     Gui shader initialized already.
    //
    // Parameters:
    //   dt:
    //

...
public class CreativeTabAndStackList
{
    //
    // Summary:
    //     A list of creative tabs to put items into. Note that all itemstacks in Vintagestory.API.Common.CreativeTabAndStackList.Stacks
    //     will be placed in all tabs.
    [DocumentAsJson]
    public string[] Tabs;

    //
    // Summary:
    //     A list of item stacks to put in tabs. Note that every itemstack here will be
    //     placed in every Vintagestory.API.Common.CreativeTabAndStackList.Tabs entry.
    [DocumentAsJson]
    public JsonItemStack[] Stacks;

    //
    // Summary:
    //     Reads the blocks and items from the Json files and converts them to an array
    //     of tabs which contain those blocks and items.
    //
    // Parameters:
    //   reader:

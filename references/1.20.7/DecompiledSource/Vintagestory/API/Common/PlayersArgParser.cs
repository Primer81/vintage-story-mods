...
public class PlayersArgParser : ArgumentParserBase
{
    ...
    public override EnumParseResult TryProcess(TextCommandCallingArgs args, Action<AsyncParseResults> onReady = null)
    {
        ...
        string group = dictionary.Get("group");
        ...
        switch (c)
        {
            ...
            case 'o':
                {
                    ...
                    for (int i = 0; i < allOnlinePlayers.Length; i++)
                    {
                        ...
                        if (matches(serverPlayer.Entity.Pos.XYZ, args.Caller.Pos, serverPlayer.PlayerName, serverPlayer.GetGroups(), serverPlayer.Role.Code, role, name, group, namematches, range))
                        {
            ...
            case 'a':
                ...
                {
                    if (matches(null, null, value.LastKnownPlayername, value.PlayerGroupMemberships.Values.ToArray(), value.RoleCode, role, name, group, namematches, null))
                    {

...
public class DamageSource
{
    ...
    //
    // Summary:
    //     The entity that caused this damage, e.g. the entity that threw the SourceEntity
    //     projectile, if any
    ...
    //
    // Summary:
    //     Get the entity that caused the damage. If a projectile like a stone was thrown
    //     this will return the entity that threw the stone instead of the stone.
    //
    // Returns:
    ...
    //
    // Summary:
    //     If we have a hitposition this returns the pitch between the attacker and the
    //     attacked position
    //
    // Parameters:
    //   attackedPos:

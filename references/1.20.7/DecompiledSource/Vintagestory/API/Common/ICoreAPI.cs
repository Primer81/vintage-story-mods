...
//
// Summary:
//     Common API Components that are available on the server and the client. Cast to
//     ICoreServerAPI or ICoreClientAPI to access side specific features.
public interface ICoreAPI : ICoreAPICommon
{
    ...
    //
    // Summary:
    //     API Component for loading and reloading one or multiple assets at once from the
    //     assets folder

...
public class Item : CollectibleObject
{
    ...
    //
    // Summary:
    //     Default textures to be used for this item. The Dictionary keys are the texture
    //     short names, as referenced in this item's shape ShapeElementFaces
    ...
    //
    // Summary:
    //     Instantiate a new item with null model transforms; ItemTypeNet will add default
    //     transforms client-side if they are null in the ItemType packet; transforms should
    //     not be needed on a server
    public Item()
    {
    }

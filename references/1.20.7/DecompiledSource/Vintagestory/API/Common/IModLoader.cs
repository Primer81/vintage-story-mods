...
public interface IModLoader
{
    ...
    //
    // Summary:
    //     Gets the enabled mod with the specified mod ID (domain). Returns null if no mod
    //     with that mod ID was found.
    ...
    //
    // Summary:
    //     Gets a loaded mod system with the specified full name, that is the namespace
    //     and class name, for example "Vintagestory.ServerMods.Core" for the survival mod.
    //     Returns null if no mod with that name was found.
    ModSystem GetModSystem(string fullName);

    //
    // Summary:
    //     Gets a loaded mod system with the specified type. Returns null if no mod of that
    //     type was found.

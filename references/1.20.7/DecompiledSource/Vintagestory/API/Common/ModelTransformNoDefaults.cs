...
//
// Summary:
//     Controls the transformations of 3D shapes. Note that defaults change depending
//     on where this class is used.
[DocumentAsJson]
...
public class ModelTransformNoDefaults
{
    ...
    //
    // Summary:
    //     For Gui Transform: Whether to slowly spin in gui item preview For Ground Transform:
    //     Whether to apply a random rotation to the dropped item No effect on other transforms
    [JsonProperty]
    ...
    public float[] AsMatrix
    {
        get
        {
            ...
            Mat4f.RotateX(array, array, Rotation.X * (MathF.PI / 180f));
            Mat4f.RotateY(array, array, Rotation.Y * (MathF.PI / 180f));
            Mat4f.RotateZ(array, array, Rotation.Z * (MathF.PI / 180f));

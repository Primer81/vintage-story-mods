...
public abstract class ParticleBase
{
    ...
    //
    // Summary:
    //     Advances the physics simulation of the particle if "physicsSim.PhysicsTickTime"
    //     seconds have passed by, otherwise it will only advance PrevPosition by the particles
    //     velocity.
    //
    // Parameters:
    //   dt:

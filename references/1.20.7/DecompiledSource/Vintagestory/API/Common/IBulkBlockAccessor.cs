...
public interface IBulkBlockAccessor : IBlockAccessor
{
    ...
    //
    // Summary:
    //     If set to true, the methods GetBlock() and GetBlockId() will behave like GetStagedBlockId()
    ...
    //
    // Summary:
    //     Gets the block for a not yet commited block. If no block has been staged for
    //     this pos the original block is returned
    //
    // Parameters:
    //   posX:
    //
    ...
    //
    // Summary:
    //     Used to fix certain things like flowing water from the edge of a pasted schematic/selection
    //     when undone or /we delete is used
    //
    // Parameters:
    //   updatedBlocks:

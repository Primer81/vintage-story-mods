...
public interface IAnimator
{
    ...
    //
    // Summary:
    //     Holds data over all animations. This list always contains all animations of the
    //     creature. You have to check yourself which of them are active
    RunningAnimation[] Animations { get; }

    //
    // Summary:
    //     Whether or not to calculate the animation matrices, required for GetAttachmentPointPose()
    //     to deliver correct values. Default on on the client, server side only on when

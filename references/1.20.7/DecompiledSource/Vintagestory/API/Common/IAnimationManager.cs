...
//
// Summary:
//     Everything needed for allowing animations the Vintagestory.API.Common.Entities.Entity
//     class holds a reference to an IAnimator. Currently implemented by Vintagestory.API.Common.ServerAnimator
public interface IAnimationManager : IDisposable
{
    ...
    //
    // Summary:
    //     Starts an animation based on the AnimationMetaData, if it exists; returns false
    //     if it does not exist (or if unable to start it, e.g. because it is already playing)
    //
    //
    // Parameters:
    //   animdata:

...
//
// Summary:
//     For performance, don't build and store new concatenated strings for every block
//     variant, item and entity, when these will only be used (if ever) for error logging
public struct SourceStringComponents
{
    ...
    //
    // Summary:
    //     Store references to the source strings, to be able to build a logging string
    //     later if necessary

...
public interface IAsset
{
    ...
    //
    // Summary:
    //     Set to true if the asset has been patched by JsonPatchLoader - if so, we don't
    //     want to unload it
    bool IsPatched { get; set; }

    //
    // Summary:
    //     If the asset is a json file you can use this convenience method to turn it into
    //     an object
    //
    // Parameters:
    //   settings:
    ...
    //
    // Summary:
    //     Turns the binary data into a Bitmap. Use for .png images. Does not work on other
    //     image formats.
    //
    // Parameters:
    //   capi:

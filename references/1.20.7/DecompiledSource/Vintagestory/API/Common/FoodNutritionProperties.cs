...
public class FoodNutritionProperties
{
    ...
    //
    // Summary:
    //     The health restored by the food. Usually actually used to hurt the player with
    //     negative values.
    [DocumentAsJson]
    public float Health;
    ...
    //
    // Summary:
    //     When an instance of this collectible is eaten, what item stack should be returned
    //     to the player? Possible example: Eating a 'meat on a stick' item would return
    //     a single stick. (Note: Bowl meals/liquids are specially designed to do this through
    //     their attributes and class.)
    [DocumentAsJson]
    public JsonItemStack EatenStack;

    //
    // Summary:
    //     Obsolete - Please use Vintagestory.API.Common.FoodNutritionProperties.Satiety
    //     instead.
    [DocumentAsJson]
    ...
    //
    // Summary:
    //     Duplicates the nutrition properties, which includes cloning the stack that was
    //     eaten.

...
public static class RuntimeEnv
{
    ...
    //
    // Summary:
    //     If true, will print the stack trace on some of the blockaccessor if something
    //     attempts to get or set blocks outside of its available chunks
    public static bool DebugOutOfRangeBlockAccess;

    //
    // Summary:
    //     If true, will print allocation trace whenever a new task was enqueued to the
    //     thread pool

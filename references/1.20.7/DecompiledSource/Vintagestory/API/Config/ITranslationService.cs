...
//
// Summary:
//     Represents a service, which provides access to translated strings, based on key/value
//     pairs read from JSON files.
public interface ITranslationService
{
    ...
    //
    // Returns:
    //     Returns null if no results are found; otherwise returns the pre-formatted, translated
    //     value.
    ...
    //
    // Returns:
    //     Returns the key if no results are found; otherwise returns the pre-formatted,
    //     translated value.
    ...
    //
    // Returns:
    //     Returns the key if no results are found; otherwise returns the unformatted, translated
    //     value.
    ...
    //
    // Summary:
    //     Used to compile the regexes, to save time on the first 'actual' wildcard search
    //     - saves about 300ms

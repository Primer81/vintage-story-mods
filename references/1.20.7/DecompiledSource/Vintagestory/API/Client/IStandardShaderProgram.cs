...
public interface IStandardShaderProgram : IShaderProgram, IDisposable
{
    ...
    //
    // Summary:
    //     The matrix for converting the vertex position from world space to far shadow
    //     space as supplied by IRenderAPI.CurrentShadowProjectionMatrix.
    float[] ToShadowMapSpaceMatrixFar { set; }

    //
    // Summary:
    //     The matrix for converting the vertex position from world space to near shadow
    //     space as supplied by IRenderAPI.CurrentShadowProjectionMatrix.

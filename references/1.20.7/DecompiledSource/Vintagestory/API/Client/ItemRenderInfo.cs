...
//
// Summary:
//     Holds information on how a collectible should be rendered in hands, on the ground
//     or in gui. In collectible.OnBeforeRender() the values are prefilled with the
//     default ones.
public class ItemRenderInfo
{
    ...
    //
    // Summary:
    //     The texture to be used when rendering. Should probalby be the texture id of the
    //     block or item texture atlas

...
public interface ILoadedSound : IDisposable
{
    ...
    //
    // Summary:
    //     Allows you to modify the pitch of the sound. May also be called while the sound
    ...
    // Summary:
    //     Allows you to modify the pitch of the sound. May also be called while the sound
    //     is currently playing. This value is added together with the normal pitch level.
    //     This method is currently used to distort sound during low temporal stability
    //
    //
    // Parameters:
    //   val:
    ...
    //
    // Summary:
    //     Allows you to modify the volumne of the sound. May also be called while the sound
    //     is currently playing.
    //
    // Parameters:
    //   val:
    ...
    //
    // Summary:
    //     Sets the current volumne again. Use this to update the sounds volumne after the
    //     global sound level has changed
    void SetVolume();
    ...
    //
    //   onFaded:
    //     Called when the fade has completed. If in the meantime another FadeXXX call has
    //     been made, the method is not called
    ...
    //
    //   onFadedOut:
    //     Called when the fade out has completed. If in the meantime another FadeXXX call
    //     has been made, the method is not called
    ...
    //
    //   onFadedIn:
    //     Called when the fade in has completed. If in the meantime another FadeXXX call
    //     has been made, the method is not called

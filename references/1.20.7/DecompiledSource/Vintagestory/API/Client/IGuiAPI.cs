...
public interface IGuiAPI
{
    ...
    //
    // Summary:
    //     If there is a currenly opened dialog or hud element, the method will return the
    //     bounds occuppying that area, otherwise null
    //
    // Parameters:
    //   area:
    ...
    //
    // Summary:
    //     Register given dialog(s) to the gui/input event listening chain. You only need
    //     to call this if your dialog has to listen to events even while closed. The method
    //     GuiDialog.TryOpen() also does the register if not registered already.
    //
    // Parameters:
    //   dialogs:
    ...
    //
    // Summary:
    //     Loads an external .svg file into a texture. Will return null if the file is not
    //     found
    //
    // Parameters:
    //   loc:
    ...
    //
    // Summary:
    //     Load the contents of a cairo surface into a opengl texture. Returns the texture
    //     id
    //
    // Parameters:
    //   surface:
    ...
    //
    // Summary:
    //     Load the contents of a cairo surface into a opengl texture. Re-uses the supplied
    //     texture exists and the size is correct. Otherwise deletes the texture and regenerates
    //     it.
    //
    // Parameters:
    //   surface:

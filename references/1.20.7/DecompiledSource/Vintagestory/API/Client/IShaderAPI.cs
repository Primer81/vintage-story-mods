...
public interface IShaderAPI
{
    //
    // Summary:
    //     Returns an empty instance of an IShaderProgram for you to configure. Once configured,
    //     call RegisterShaderProgram
    IShaderProgram NewShaderProgram();

    //
    // Summary:
    //     Returns an empty instance of an IShader for you to configure as vertex, fragment
    //     or geometry shader
    IShader NewShader(EnumShaderType shaderType);

    //
    // Summary:
    //     Registers a configured IShaderProgram. The name must correspond to the .vsh and
    //     .fsh filenames (without ending). Returns a program number to be used in UseShaderProgram()
    //
    //
    // Parameters:
    //   name:
    ...
    //
    // Summary:
    //     Registers a configured IShaderProgram. Will not load anything from the shaders
    //     folder. Returns a program number to be used in UseShaderProgram()
    //
    // Parameters:
    //   name:
    //
    ...
    //
    // Summary:
    //     Discards all currently compiled shaders and recompiles them. Returns true if

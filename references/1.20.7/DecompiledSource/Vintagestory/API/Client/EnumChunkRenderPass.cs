...
public enum EnumChunkRenderPass
{
    ...
    //
    // Summary:
    //     Uses a special rendering system called Weighted Blended Order Independent Transparency
    //     for half transparent blocks
    Transparent,
    //
    // Summary:
    ...
    //
    // Summary:
    //     Special render pass for top soil only in order to have climated tinted grass
    //     half transparently overlaid over an opaque block
    TopSoil,
    //
    // Summary:

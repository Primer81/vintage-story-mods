...
public enum EnumRenderStage
{
    ...
    //
    // Summary:
    //     To render the held item over water. If done in the opaque pass it would not render
    //     water behind it.
    AfterOIT,
    //
    // Summary:
    ...
    //
    // Summary:
    //     The post processing passes are merged with all 3d geometry and the scene is color
    //     graded
    AfterFinalComposition,
    //
    // Summary:
    //     Scene is blitted onto the default frame buffer, buffers not yet swapped though
    //     so can still render to default FB
    Done
}

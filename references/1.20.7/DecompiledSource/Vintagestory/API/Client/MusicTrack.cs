...
public class MusicTrack : IMusicTrack
{
    ...
    //
    // Summary:
    //     If true, the music is considered active/playing until set to false and so no
    //     other track will play
    ...
    //
    // Summary:
    //     Updates the volume of the current track provided Sound is not null. (effectively
    //     calls Sound.SetVolume)

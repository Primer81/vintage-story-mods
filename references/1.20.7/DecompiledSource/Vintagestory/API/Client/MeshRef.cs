...
//
// Summary:
//     A reference to a mesh that's been uploaded onto the graphics card (i.e. that
//     has been placed in an OpenGL VAO). This reference can be used for rendering it.

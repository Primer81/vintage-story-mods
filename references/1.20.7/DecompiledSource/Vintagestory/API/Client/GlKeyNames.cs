...
public static class GlKeyNames
{
    ...
    //
    // Summary:
    //     Gets the string the key would produce upon pressing it without considering any
    //     modifiers (but single keys get converted to uppercase). So GlKeys.W on QWERTY
    //     Keyboard layout returns W, GlKeys.Space returns Space etc.
    //
    // Parameters:
    //   key:
    ...
    //
    // Summary:
    //     Returns the printable character for a key. Does return null on none printable
    //     keys like Vintagestory.API.Client.GlKeys.Enter
    //
    // Parameters:
    //   key:

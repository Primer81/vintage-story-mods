...
//
// Summary:
//     The world accessor implemented by the client, offers some extra features only
...
public interface IClientWorldAccessor : IWorldAccessor
{
    ...
    //
    // Summary:
    //     Gets the MapSizeY on the client, for chunk column enumeration, without this this
    ...
    //
    // Summary:
    //     Loads the rgb climate and season color map value at given position and multiplies
    //     it byte-wise with supplied color
    //
    // Parameters:
    //   climateColorMap:
    //
    ...
    //
    // Summary:
    //     Loads the rgb climate and season color map value for given rain and temp value
    //     and multiplies it byte-wise with supplied color
    //
    // Parameters:
    //   climateColorMap:
    //
    ...
    //
    // Summary:
    //     Loads a sounds without playing it. Use to individually control when to play/stop.
    //     Might want to set DisposeOnFinish to false but then you have to dispose it yourself.
    //
    //
    // Parameters:
    //   param:
    ...
    //
    // Summary:
    //     Same effect as when player left-click breaks a block, but will not cause actual
    //     breakage of the block
    //
    // Parameters:
    //   withTool:
    //
    ...
    //
    // Summary:
    //     Exactly like PlaySoundAt except that it returns the duration of the played sound.
    //     (We don't want to change the method signature of PlaySoundAt for API mod breakage
    //     reasons)

...
public enum HotkeyType
{
    ...
    //
    // Summary:
    //     Controls that control the players movement. Only available when the player not
    //     currently inside a dialog.
    MovementControls,
    //
    // Summary:
    //     Controls that control the players actions. Only triggered when the player not
    //     currently inside a dialog.
    CharacterControls,
    //
    // Summary:

...
//
// Summary:
//     API Features to set up a network channel for custom server<->client data exchange.
//     Client side.
public interface IClientNetworkAPI : INetworkAPI
{
    ...
    //
    // Summary:
    //     Sends a blockentity interaction packet to the server. For quick an easy blockentity
    //     network communication without setting up a channel first.
    //
    // Parameters:
    //   x:
    //
    ...
    //
    // Summary:
    //     Sends a entity interaction packet to the server. For quick an easy entity network
    //     communication without setting up a channel first.
    //
    // Parameters:
    //   entityid:
    //
    ...
    //
    // Summary:
    //     Sends the players entity position (and Mount position) via UDP (if possible)
    //     to the server
    ...
    //
    // Summary:
    //     Sends given packet data to the server. This let's you mess with the raw network
    //     communication and fiddle with internal engine packets if you know the protocol.
    //     For normal network communication you probably want to register your own network
    //     channel.
    //
    // Parameters:
    //   data:
    ...
    //
    // Summary:
    //     Sends given packet to server. For use with inventory supplied network packets
    //     only, since the packet format is not exposed to the api
    //
    // Parameters:
    //   packetClient:
    ...
    //
    //   firstEvent:
    //     Is it the first of this events for this block? (by default the client calls the
    //     interaction every second while the player holds down the right mouse button)
    //
    //
    //   cancelReason:
    ...
    //
    // Summary:
    //     If any mod denies the client event IsPlayerReady, then it has to call this method
    //     once to indicate that the player is now ready to play (which switches the server
    //     side client state from Connected to Playing)
    void SendPlayerNowReady();

    //
    // Summary:
    //     Sends a blockentity interaction packet to the server. For quick an easy blockentity
    //     network communication without setting up a channel first. Uses Protobuf.net to
    //     serialize your data
    //
    // Parameters:
    //   pos:

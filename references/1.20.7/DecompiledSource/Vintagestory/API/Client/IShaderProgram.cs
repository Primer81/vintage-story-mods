...
public interface IShaderProgram : IDisposable
{
    ...
    //
    // Summary:
    //     The name it was registered with. If you want to load this shader from a file,
    //     make sure the use the filename here
    string PassName { get; }

    //
    // Summary:
    //     If true, it well configure the textures to clamp to the edge (CLAMP_TO_EDGE).
    //     Requires the textureid to be defined using SetTextureIds

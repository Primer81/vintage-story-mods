...
public class TextureAtlasPosition
{
    ...
    //
    // Summary:
    //     A sequential number in which atlas this position is in. Atlasses for a given
    //     type are sequentially numbered if more than one atlas was required to hold all
    //     the textures
    public byte atlasNumber;

    //
    // Summary:
    //     A sequential number that goes up with every texture atlas reload, used to see
    //     if this texpos is still fresh

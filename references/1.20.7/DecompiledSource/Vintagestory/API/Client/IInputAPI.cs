...
//
// Summary:
//     This interface manages the inputs of the player and is used mostly on the client
//     side.
public interface IInputAPI
{
    ...
    //
    // Summary:
    //     The current keyboard key states, use the Vintagestory.API.Client.GlKeys enum
    //     to get the index of an array key.
    bool[] KeyboardKeyStateRaw { get; }

    //
    // Summary:
    //     The current keyboard key states that were not handled by a dialog or other client
    //     systems (exception: hotkeys), use the Vintagestory.API.Client.GlKeys enum to
    //     get the array index of a key.
    ...
    //
    // Summary:
    //     The current x-position of the mouse, relative to the upper left corner of the
    //     game window
    int MouseX { get; }

    //
    // Summary:
    //     The current y-position of the mouse, relative to the upper left corner of the
    //     game window
    int MouseY { get; }
    ...
    //
    // Summary:
    //     When controlling the camera, this is the camera pitch determined by the game
    //     engine
    float MousePitch { get; set; }

    //
    // Summary:
    //     Gives the player the ability to still interact with the world even if a gui dialog
    //     is opened
    bool MouseWorldInteractAnyway { get; set; }

    //
    // Summary:
    //     True if the mouse cursor is currently grabbed and not visible. (Such as while
    //     controlling the character's view in first person.)
    ...
    //
    // Summary:
    //     Triggered when the player attempts to trigger an action, such as walking forward
    //     or sprinting
    ...
    //
    // Summary:
    //     Registers a hot key with given default key combination, the player will be able
    //     change these in the controls. Supplied hotkeyCode can than be used to register
    //     a hotkey handler.
    //
    // Parameters:
    //   hotkeyCode:
    ...
    //
    // Summary:
    //     Will call the handler if given hotkey has been pressed. Removes the previously
    //     assigned handler.
    //
    // Parameters:
    //   hotkeyCode:

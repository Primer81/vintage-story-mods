...
//
// Summary:
//     A custom itemstack render handler. This method is called after Collectible.OnBeforeRender().
//     For render target gui, the gui shader and its uniforms are already fully prepared,
//     you may only call RenderMesh() and ignore the modelMat, position and size values
...
//
//   modelMat:
//     The model transformation matrix with position and size already preapplied, you
//     can choose to ignore this value
//
//   posX:
...
//
//   posZ:
//     The depth position. Higher values might be required for very large models, which
//     can cause them to poke through dialogs in front of them, however
//
//   size:
...
//
//   showStackSize:
//     Whether or not to show the stack size (some parts of the game have this on or
//     off)

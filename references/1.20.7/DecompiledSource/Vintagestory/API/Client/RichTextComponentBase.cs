...
public abstract class RichTextComponentBase
{
    ...
    //
    // Summary:
    //     This will be the Y-Advance into the next line. Unscaled value. Also used as the
    //     offset with EnumVerticalAlign.FixedOffset
    public virtual double UnscaledMarginTop { get; set; }

    //
    // Summary:
    //     Padding that is used when a richtextcomponent came before and needs some left
    //     spacing to it. Unscaled value

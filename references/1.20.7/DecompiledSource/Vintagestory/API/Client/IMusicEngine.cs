...
public interface IMusicEngine
{
    ...
    //
    // Summary:
    //     The total passed milliseconds since game start at the point where the last track
    //     stopped playing
    long MillisecondsSinceLastTrack { get; }

    //
    // Summary:
    //     Loads the sound into memory and plays the track. Slow call. Encapsulate it into
    //     ThreadPool.QueueUserWorkItem() to not block the main thread
    //
    // Parameters:
    //   location:
    //

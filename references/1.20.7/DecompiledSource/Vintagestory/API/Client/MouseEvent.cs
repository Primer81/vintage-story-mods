...
public class MouseEvent
{
    ...
    //
    // Summary:
    //     This is apparently used for mouse move events (set to true if the mouse state
    //     has changed during constant polling, set to false if the move event came from
    //     opentk. This emulated state is apparantly used to determine the correct delta
    //     position to turn the camera.

...
//
// Summary:
//     A datastructure to hold 2 dimensional data in the form of ints. Can be used to
//     perfrom bilinear interpolation between individual values
[ProtoContract]
public class IntDataMap2D
{
    ...
    //
    // Summary:
    //     The parameters should both be in the range 0..1. They represent the position
    //     within the MapRegion. Calling code may need to use the (float)((double)val %
    //     1.0) technique to ensure enough bits of precision when taking the fractional
    //     part (% 1.0), if val is large (for example a BlockPos in a 8Mx8M world)
    //
    // Parameters:
    //   x:
    //
